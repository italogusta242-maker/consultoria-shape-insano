...
import { parseAnamneseCSV } from "./csvAnamneseParser";
...
describe("csvAnamneseParser", () => {
    it("should parse a valid CSV line correctly into nested objects", () => {
        ...
        columns[0] = "01/01/2026 12:00:00"; // timestamp (skip table but required for validation)
        ...
        // Extras checks
        expect((parsed.dados_extras as any).fotos?.foto_frente).toBe("https://drive.google.com/frente.jpg");
